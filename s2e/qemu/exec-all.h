...
///[fwl]声明cpu_gen_llvm函数，翻译成llvm指令
#ifdef CONFIG_S2E
...
///[fwl]声明llvm::Function及s2e::S2ETranslationBlock以及枚举ETranslationBlockType和JumpType
#ifdef CONFIG_LLVM
...
///[fwl]s2e的registers以及tb块的一些结构和变量。
#ifdef CONFIG_S2E
...
///[fwl]将tb->s2e_tb_next[n]及tb->llvm_tb_next[n]指向tb_next
#ifdef CONFIG_S2E
