...
///[fwl]声明io_make_symb mmu函数和io_read_chk_symb mmu函数
...
///[fwl]s2e下，声明io_read mmu_symb和io_write mmu_symb函数
#ifdef CONFIG_S2E
...
///[fwl]声明s2e_notdirty_mem_write，s2e_ismemfunc。具体实现见exec.c。
