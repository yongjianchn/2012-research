 ...
 *
 */
///[fwl]将本文件所有CPUState->CPUArchState
...
/*[fwl]
 *非CONFIG_S2E下，增加load和store的le和be宏定义，TODO
 */
...
/*[fwl]
 *CONFIG_S2E下
 *增加静态内联函数_s2e_check_concrete检查是否是具体执行
 *增加s2e的ld和st宏定义；后缀为symb的宏如果在具体模式下调用会中止执行。
 */
#else /* CONFIG_S2E */
...
///[fwl]增加CPU_INTERRUPT_TGT_INT_3宏定义
...
#define CPU_LOG_LLVM_IR    (1 << 10)		///[fwl]增加CPU_LOG_LLVM_IR宏定义
#define CPU_LOG_LLVM_ASM   (1 << 11)		///[fwl]增加CPU_LOG_LLVM_ASM宏定义
