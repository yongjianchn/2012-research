...
///[fwl]若s2e_is_mmio_symbolic_[bwlq]函数返回1，则切到符号执行。
#ifdef CONFIG_S2E
...
///[fwl]io_read_chk[bwlq]_[c]mmu内联函数
...
///[fwl]io_make_symbolic[bwlq]内联函数
...
///[fwl]io_read_chk_symb_[bwlq]内联函数
...
///[fwl]定义helper_ld[bwlq]_mmu函数，增加了若干ifndef S2E_LLVM_LIB
DATA_TYPE
                                                       ...
                                                       int mmu_idx)
{
 ...
 redo:
	///[fwl]增加likely，unlikely；do_unaligned_access:？？？
...
///[fwl]如果可能是具体值，则res=ld[ub/uw/l/q]_p否则res=ld[ub/uw/l/q]_raw
...
///[fwl]对照上边define S2E_LLVM_LIB下io_read_chk[bwlq]_[c]mmu函数，有一些差别。
/**
